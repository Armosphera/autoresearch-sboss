"""
eval.py — fixed eval harness for the phone-am example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs normalize_nsn / is_valid_armenian_phone / e164 / format_phone over the eval set,
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [phone-am example]")
