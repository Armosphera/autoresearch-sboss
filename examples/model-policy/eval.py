"""
eval.py — fixed eval harness for the model-policy example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs run_workflow() over the eval set in eval_set.json, computes field-level exact-match
F1 over {resolved_model, source}, prints the result.
"""
...
EVAL_FIELDS = ("resolved_model", "source")
VALID_SOURCES = ("module", "aspect", "default", "auto")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [model-policy example]")
