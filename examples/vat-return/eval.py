"""
eval.py — fixed eval harness for the vat-return example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs compute_vat_return() (from workflow.py) over the eval set in eval_set.json,
computes field-level exact-match F1 over {outputVat, inputVat, taxableSales,
taxablePurchases, net, payable, creditCarried}, prints the result.
"""
...
EVAL_FIELDS = ("outputVat", "inputVat", "taxableSales", "taxablePurchases", "net", "payable", "creditCarried")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [vat-return example]")
