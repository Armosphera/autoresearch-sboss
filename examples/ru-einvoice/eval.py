"""
eval.py — fixed eval harness for the ru-einvoice example.
...
{ok, error_count, error_codes} field set.
Mirrors the einvoice-am example pattern.
"""
...
EVAL_FIELDS = ("ok", "error_count", "error_codes")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [ru-einvoice example]")
