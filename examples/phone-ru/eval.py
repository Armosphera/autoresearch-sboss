"""
eval.py — fixed eval harness for the phone-ru example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs normalize_nsn / is_valid_russian_phone / e164 / format_phone over the eval set,
computes field-level exact-match F1 over {nsn, valid, e164, formatted}.
Mirrors the phone-am example pattern.
"""
...
EVAL_FIELDS = ("nsn", "valid", "e164", "formatted")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [phone-ru example]")
