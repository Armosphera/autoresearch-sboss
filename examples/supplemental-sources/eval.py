"""
eval.py — fixed eval harness for the supplemental-sources example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Per-case field set scoring with count, titles, excerpts, sourceUrls, scores,
allAdvisory. per_field_pct divides by count of cases with that field.
"""
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [supplemental-sources example]")
