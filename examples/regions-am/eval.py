"""
eval.py — fixed eval harness for the regions-am example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs find_region() over the eval set in eval_set.json, computes field-level
exact-match F1 over {found, code, hy, en, center}.
"""
...
EVAL_FIELDS = ("found", "code", "hy", "en", "center")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [regions-am example]")
