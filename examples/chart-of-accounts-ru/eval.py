"""
eval.py — fixed eval harness for the chart-of-accounts-ru example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs account_by_code() over the eval set, computes field-level exact-match F1
over {found, code, ru, section, nature, normalBalance}.
"""
...
EVAL_FIELDS = ("found", "code", "ru", "section", "nature", "normalBalance")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [chart-of-accounts-ru example]")
