"""
eval.py — fixed eval harness for the vat-return-form example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_vat_return_form() over the eval set, computes field-level exact-match
F1 over {ok, error_count, error_codes}.
"""
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [vat-return-form example]")
