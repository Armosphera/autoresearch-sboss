"""
eval.py — fixed eval harness for the regions-ru example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs find_region() over the eval set, computes field-level exact-match F1 over
{found, code, ru, en, center}. Mirrors the regions-am example pattern.
"""
...
EVAL_FIELDS = ("found", "code", "ru", "en", "center")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [regions-ru example]")
