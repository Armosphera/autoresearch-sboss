"""
eval.py — fixed eval harness for the CPF (Brazilian individual taxpayer id) example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_cpf() (from workflow.py) over the eval set in eval_set.json, computes a
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [cpf example]")
