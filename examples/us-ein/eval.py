"""
eval.py — fixed eval harness for the US EIN (Employer Identification Number) example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_ein() (from workflow.py) over the eval set in eval_set.json, computes a
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [us-ein example]")
