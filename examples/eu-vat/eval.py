"""
eval.py — fixed eval harness for the EU VAT (VAT identification number) example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_vat() (from workflow.py) over the eval set in eval_set.json, computes a
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [eu-vat example]")
