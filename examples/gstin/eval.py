"""
eval.py — fixed eval harness for the India GSTIN (Goods and Services Tax Identification Number) example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_gstin() (from workflow.py) over the eval set in eval_set.json, computes a
field-level exact-match F1 score (ok, normalized, error), prints the result, and exits 0/1.
"""
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [gstin example]")
