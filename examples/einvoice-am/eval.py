"""
eval.py — fixed eval harness for the einvoice-am example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_e_invoice() over the eval set, computes field-level F1 over
{ok, error_count, error_codes}.
"""
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [einvoice-am example]")
