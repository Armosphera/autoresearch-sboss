"""
eval.py — fixed eval harness for the product-research example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Per-case field set scoring with per_field_pct divided by count of cases that
have that field.
"""
...
def _eq(a, b) -> bool:
    ...
    if isinstance(a, (int, float)) and isinstance(b, (int, float)):
        # Approximate float comparison (JS Math gives 0.0999... for 0.6-0.5)
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [product-research example]")
