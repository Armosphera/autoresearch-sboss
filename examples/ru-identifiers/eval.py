"""
eval.py — fixed eval harness for the ru-identifiers example.

DO NOT MODIFY. The agent edits workflow.py. This file is the judge.

Runs validate_identifier() (from workflow.py) over the eval set in eval_set.json,
computes field-level exact-match F1 over {ok, normalized, kind, error}, prints the result.
"""
...
EVAL_FIELDS = ("ok", "normalized", "kind", "error")
...
def main() -> int:
    ...
    print("autoresearch-sboss eval [ru-identifiers example]")
